...
namespace canny
{        
    public class Canny_Edge_Detection 
    {
        ...
        /// <param name="Th"></param>
        /// <param name="Tl"></param>
        /// <param name="GaussianMaskSize"></param>
        /// <param name="SigmaforGaussianKernel">for N=2 Sigma =0.85  N=5 Sigma =1, N=9 Sigma = 2    2*Sigma = (int)N/2</param>
        public Canny_Edge_Detection(int[,] inputImage, 
            float Th= 20F, float Tl= 10F, int GaussianMaskSize = 5, 
        ...
        public int[,] DetectCannyEdges()
        {
            ...
            ComputeGradientMagnitude(Gradient, DerivativeX, DerivativeY);
            // Perform Non maximum suppression:
            // NonMax = Gradient;
            PerformNonMax(Gradient, NonMax);
        ...
        private void PerformNonMax(float[,] Gradient, float[,] NonMax)
        {
        ...
        private void ComputeGradientMagnitude(float[,] Gradient, float[,] DerivativeX, float[,] DerivativeY)
        {
            for (int i = 0; i <= (Width - 1); i++)
            {
                for (int j = 0; j <= (Height - 1); j++)
